  ...
  return (
    ...
    data-aos-easing="ease-in-sine" id='home' className='text-white m-10 gap-1'>
      ...
      src={profileimg} alt="" className=' size-4/5 mx-auto md:size-3/12   lg:size-3/12 ' />
        <h1  className='text-3xl md:text-5xl lg:text-7xl'><span className=' sm:text-3xl md:text-5xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-yellow-500 md:break-after-column'>I'm Kundan Bora,</span>Frontend developer</h1>
        <p data-aos="fade-up"
     ...
     data-aos-anchor-placement="top-bottom" className='grid justify-center items-center  md:flex md:justify-center md:gap-3 md:content-center md:mt-2  lg:flex lg:justify-center lg:gap-3 lg:content-center lg:mt-2'>
      <div className='px-1 py-1 connt-btn'><AnchorLink className='anchor-link'href='#Contact'>Connect With Me </AnchorLink></div>
      <div className=' p-1 connt-btn  '><a href={my_resume}
      target='_blank'   className="">My Resume</a>
</div>
      </div>
