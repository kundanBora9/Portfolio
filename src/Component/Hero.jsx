...
function Hero() {
  return (
    <div id='home' className='text-white m-10 gap-1'>
      ...
      <div className='border p-1 rounded-lg cursor-pointer hover:border-indigo-800 '><a href={my_resume}
      target='_blank'   className="text-white">My Resume</a>
</div>
      </div>
